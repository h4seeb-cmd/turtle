...
One advantage is that simulations can account for natural variables using random number generators. One disadvantage is that simulations can often contain bias.
...
<span class="n">range1</span> <span class="o">=</span> <span class="nb">int</span><span class="p">(</span><span class="nb">input</span><span class="p">(</span><span class="s2">&quot;Whats the lowest number you want to randomize by??&quot;</span><span class="p">))</span>
<span class="n">range2</span> <span class="o">=</span> <span class="nb">int</span><span class="p">(</span><span class="nb">input</span><span class="p">(</span><span class="s2">&quot;Whats the highest number you want to randomize by??&quot;</span><span class="p">))</span>
<span class="nb">print</span><span class="p">(</span><span class="n">r</span><span class="o">.</span><span class="n">randint</span><span class="p">(</span><span class="n">range1</span><span class="p">,</span><span class="n">range2</span><span class="p">))</span>

<span class="c1"># CHALLENGE 2</span>
<span class="c1">#def clothingRemover():</span>
</pre></div>
...
<span class="ansi-green-intense-fg ansi-bold">/home/h4seeb/vscode/turtle/_notebooks/2022-11-30-SimulationStudentLesson.ipynb Cell 10</span> in <span class="ansi-cyan-fg">&lt;cell line: 4&gt;</span><span class="ansi-blue-fg">()</span>
<span class="ansi-green-intense-fg ansi-bold">      &lt;a href=&#39;vscode-notebook-cell://wsl%2Bubuntu-20.04/home/h4seeb/vscode/turtle/_notebooks/2022-11-30-SimulationStudentLesson.ipynb#X11sdnNjb2RlLXJlbW90ZQ%3D%3D?line=4&#39;&gt;5&lt;/a&gt;</span> chooseCorner = input(&#34;What corner do you choose?&#34;)
<span class="ansi-green-intense-fg ansi-bold">      &lt;a href=&#39;vscode-notebook-cell://wsl%2Bubuntu-20.04/home/h4seeb/vscode/turtle/_notebooks/2022-11-30-SimulationStudentLesson.ipynb#X11sdnNjb2RlLXJlbW90ZQ%3D%3D?line=6&#39;&gt;7&lt;/a&gt;</span> corner = random.randint(1,4)
<span class="ansi-green-fg">----&gt; &lt;a href=&#39;vscode-notebook-cell://wsl%2Bubuntu-20.04/home/h4seeb/vscode/turtle/_notebooks/2022-11-30-SimulationStudentLesson.ipynb#X11sdnNjb2RlLXJlbW90ZQ%3D%3D?line=8&#39;&gt;9&lt;/a&gt;</span> if int(chooseCorner) == corner:
<span class="ansi-green-intense-fg ansi-bold">     &lt;a href=&#39;vscode-notebook-cell://wsl%2Bubuntu-20.04/home/h4seeb/vscode/turtle/_notebooks/2022-11-30-SimulationStudentLesson.ipynb#X11sdnNjb2RlLXJlbW90ZQ%3D%3D?line=9&#39;&gt;10&lt;/a&gt;</span>     status = &#34;out&#34;
<span class="ansi-green-intense-fg ansi-bold">     &lt;a href=&#39;vscode-notebook-cell://wsl%2Bubuntu-20.04/home/h4seeb/vscode/turtle/_notebooks/2022-11-30-SimulationStudentLesson.ipynb#X11sdnNjb2RlLXJlbW90ZQ%3D%3D?line=10&#39;&gt;11&lt;/a&gt;</span>     print(&#34;You chose corner number &#34; + chooseCorner + &#34; and you&#39;re OUT&#34;)
...
<span class="k">def</span> <span class="nf">coinflip</span><span class="p">():</span>         <span class="c1">#def function </span>
    <span class="n">randomflip</span> <span class="o">=</span> <span class="n">r</span><span class="o">.</span><span class="n">randint</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">3</span><span class="p">)</span> <span class="c1">#picks either 0 or 1 randomly (50/50 chance of either) </span>
...
<span class="k">def</span> <span class="nf">randomNumber</span><span class="p">():</span>
    <span class="n">n</span> <span class="o">=</span> <span class="n">r</span><span class="o">.</span><span class="n">randint</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span><span class="mi">255</span><span class="p">)</span>
    <span class="k">return</span> <span class="n">n</span> 

<span class="k">def</span> <span class="nf">binConvert</span><span class="p">(</span><span class="n">N</span><span class="p">):</span>
    <span class="nb">bin</span><span class="p">(</span><span class="n">N</span><span class="p">)</span>
    <span class="k">return</span> <span class="n">N</span>
    
<span class="k">def</span> <span class="nf">survivors</span><span class="p">():</span>
    <span class="n">household</span> <span class="o">=</span> <span class="p">[</span><span class="s2">&quot;nathan&quot;</span><span class="p">,</span> <span class="s2">&quot;sorry&quot;</span><span class="p">,</span> <span class="s2">&quot;alex&quot;</span><span class="p">,</span> <span class="s2">&quot;haseeb&quot;</span><span class="p">,</span> <span class="s2">&quot;mort&quot;</span><span class="p">,</span> <span class="s2">&quot;yeung&quot;</span><span class="p">,</span> <span class="s2">&quot;chinmay&quot;</span><span class="p">,</span> <span class="s2">&quot;tanay&quot;</span><span class="p">]</span>
</pre></div>
